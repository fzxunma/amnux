...
<template>
  <n-layout style="height: 100vh;">
    <n-layout-header bordered
      style="height: 48px; padding: 4px;line-height:40px; text-align: center; font-size: large; font-weight: bold;">
    ...
    <n-layout has-sider position="absolute" style="top: 48px; bottom: 32px" bordered>
      ...
      <n-layout-content style="padding: 24px; background: #fcfcfc;">
        <XmMetaEditor :metaType="metaType" :key="activeType" :type="activeType" :page-title="`${activeType} 配置管理`" />
      </n-layout-content>
    </n-layout>
