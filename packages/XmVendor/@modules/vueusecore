...
function useParallax(target, options = {}) {
  ...
  const orientation = reactive2(/* @__PURE__ */ useDeviceOrientation({ window: window$1 }));
  const screenOrientation = reactive2(/* @__PURE__ */ useScreenOrientation({ window: window$1 }));
...
var TransitionPresets = /* @__PURE__ */ Object.assign({}, { linear: identity }, _TransitionPresets);
